...
import java.util.Random;
 ...
 class ElectricFanLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mWidth = LocalDisplay.dip2px(context, DEFAULT_WIDTH);
        mHeight = LocalDisplay.dip2px(context, DEFAULT_HEIGHT);
        mTextSize = LocalDisplay.dip2px(context, DEFAULT_TEXT_SIZE);
        mStrokeWidth = LocalDisplay.dip2px(context, DEFAULT_STROKE_WIDTH);
        mCenterRadius = LocalDisplay.dip2px(context, DEFAULT_CENTER_RADIUS);
        mProgressCenterRadius = LocalDisplay.dip2px(context, DEFAULT_PROGRESS_CENTER_RADIUS);

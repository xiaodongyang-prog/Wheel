...
public class ImitateKeepButton extends View {
    ...
    private void initAttributes() {
        ringBgColor = (ringBgColor != null) ? ringBgColor : ColorStateList.valueOf(getResources().getColor(R.color.dodger_blue));
        ringColor = (ringColor != null) ? ringColor : ColorStateList.valueOf(getResources().getColor(R.color.dodger_blue));
        circleColor = (circleColor != null) ? circleColor : ColorStateList.valueOf(getResources().getColor(R.color.dodger_blue));
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        //画圆
        ringRadius = mRadius - LocalDisplay.dip2px(getContext(),value/2);
